...
const Navbar = ({ toggleIsShowLoginModal }) => {
  return (
    <div className="bg-primary sticky -top-20 md:-top-28 z-10 xl:relative xl:top-0">
        ...
        <div className="grid grid-cols-2 gap-4 items-center xl:grid-cols-3">
          ...
          <div className="grid-cols-1 flex items-center justify-end space-x-5">
            <div className="flex flex-wrap space-x-3 items-center">
              <Button toggleIsShowLoginModal={toggleIsShowLoginModal}>
                Sign in
              </Button>
